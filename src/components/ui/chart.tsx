...
// CAMBIO CLAVE: Quitamos payload y label de la desestructuración de la firma
function ChartTooltipContent({
  ...
  // Extraemos payload y label de props de forma manual para evitar el error ts(2339)
  const tooltipPayload = (props as any).payload as
    | Payload<ValueType, NameType>[]
    | undefined;
  const tooltipLabelValue = (props as any).label as string | number | undefined;
